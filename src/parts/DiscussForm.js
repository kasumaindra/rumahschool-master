...
export default function DiscussForm(props) {
  ...
  const submitEmail = () => {
    const {
      name, company, email, phone, question,
    } = data;
    ...
    <section className="flex flex-col container mx-auto mt-10 justify-center">
      <Fade bottom>
        ...
        <p className="font-light text-lg text-gray-400 text-center mb-12">          
          ...
          Please fill out the form below to discuss your question and we'll get back to you in less than 24 hours.
        </p>
        ...
        <div className="flex flex-col">
          ...
          <div className="mx-auto">
            <Form
              ...
              placeholder="Explain about your question"
              className=""
              onChange={props.onChange}
            />
          </div>
